                ...
                <Link to='/view' className=''>
                    <div className='aspect-3/2 relative'>
                        ...
                        <div className='bg-primary px-2 py-1 rounded-md absolute bottom-4 left-4'>
                            <p className='text-gray-800 font-semibold text-lg uppercase'>{props.category.name}</p>
                        </div>
                    </div>
                </Link>
                <div className="pt-5">
                    <Link to="/view">
                        <h5 className="text-2xl font-semibold text-gray-800">{props.title}</h5>
                    </Link>
                    <div className="flex justify-between items-center pt-5">
                        <span className='flex items-center cursor-pointer'>
                            <img src={userImg} alt="" className='rounded-full w-8 h-8 mr-2 flex-shrink-0' />
                            <p className='text-md text-gray-800'>{props.user.givenName}</p>
                        </span>
