    ...
    return (
        <div className='flex justify-center'>
            <div className="w-full">
                <div className='pb-5'>
                    <h5 className="flex-1 xl:text-4xl md:text-3xl text-2xl font-semibold tracking-tight text-gray-800">Reflect! The brand new blog website.</h5>
                </div>
                <div href="#" className='relative aspect-3/2'>
                    <img className="rounded-xl w-full h-full object-cover object-center" src={postOne} alt="product image" />
