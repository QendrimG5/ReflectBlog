            ...
            {posts.map((i) => {
              ...
              return <div key={i.id} className="w-full gap-10">
                <Link to='/view-your-post' className='relative'>
                  <img className="rounded-lg active:scale-[.98] active:duration-75 hover:scale-[1.05] ease-in-out transition-all" src={i.imageUrl} alt="product image" />
                  <div className='bg-primary px-2 py-1 rounded-md absolute bottom-4 left-4'>
                    <p className='text-gray-800 font-semibold text-lg uppercase'></p>
                  </div>
                </Link>
                <div className="pt-5">
